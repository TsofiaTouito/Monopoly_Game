...
Board::Board() {
    ...
    for (const auto& square : squares) {
        ...
        if (StreetSquare* street = dynamic_cast<StreetSquare*>(square)) {
            // If the cast is successful, create a new StreetSquare using a raw pointer
            this->allStreets.push_back(new StreetSquare(*street)); // Copy the StreetSquare
        }
    }
}
...
vector<StreetSquare*>& Board::get_allStreets(){
